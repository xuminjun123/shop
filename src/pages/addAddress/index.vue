<!--
 * @Description: 个人版 新增收货地址
 * @Author: xmj
 * @Date: 2022-09-13 14:21:33
-->
<template>
  <view class="addAddress-continer">
    <view class="w-11/12 pt-2 mx-auto">
      <uni-forms
        :modelValue="formData"
        label-position="left"
        label-width="100"
