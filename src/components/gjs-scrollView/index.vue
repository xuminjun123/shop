<template>
  <view class="flex">
    <scroll-view
      :scroll-y="true"
      style="width: 30%; height: 100vh; border-right: 5rpx solid #ccc"
    ...
    >
      <view
        ...
        :class="activeIndex == index ? 'selected' : 'notSelectType'"
        style=""
      >
        <view
    ...
    >
      ...
      >
        <view class="" :id="'sv-' + index">
          <view>
            <view class="flex justify-between w-11/12">
              <view>
                <view> {{ item.title }}</view>
              </view>
              <view class="flex">
                <view class="ml-2" v-for="(type, i) in types" :key="i">{{
                  type
                }}</view>
              </view>
            </view>
          ...
          <!-- <view
            ...
            class="flex w-full"
          >
            <view class="flex w-1/3 mr-1" style="background: #F8F8FA">
              <img :src="it.img" mode="widthFix" />
            </view>
          </view> -->
          <tm-grid :width="500" :col="3">
            <tm-grid-item v-for="(it, index) in item.list" :key="index">
              <view class="">
                <img :src="it.img" mode="widthFix" />
                <tm-text :label="it.text"></tm-text>
              </view>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const position = ref("");
    const leftClick = (index: number, item: any) => {
      activeIndex.value = index;
      position.value = "sv-" + index;
    };
    const rightClick = (item: any) => {
      console.log(item);
    };
    const scroll_detail = (e: any) => {
